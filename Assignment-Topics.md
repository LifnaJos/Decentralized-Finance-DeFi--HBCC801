...
Note : 
1. Draw the relevant diagram to demonstrate the scenario
2. Prepare the document and mail the document in the group.


## *Class Assignment - 2* 
#### Date of Preparation & Submission : 9th April 2026
...
4. Define derivatives and explain types such as futures, options, and swaps.
5. Discuss the role of derivatives in risk management.
6. Compare crypto derivatives with traditional financial derivatives.
7. Explain the working of Tether and its peg mechanism.
8. Describe the elastic supply mechanism used by Ampleforth.
9. How to Get Stablecoins
10. Explain different methods to acquire stablecoins (DEX, CEX, minting).
11. What are the risks involved in acquiring stablecoins through DeFi platforms?
12. Explain the working of Synthetix Network.
13. What are synthetic assets (Synths), and how are they created?
14. Discuss the rise and fall of The DAO and its impact on Ethereum.
15. Explain how DAO projects function and their advantages over traditional organizations.
